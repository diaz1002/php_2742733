        ...
        <img class="im" src="./galeria/us.png" alt="">
            <div class="card-body">
                ...
                <form action="index.php" method="POST">
                    ...
                    <input class="us" id="usuario" type="text" placeholder="Nombre de usuario..." name="usuario">
                    <br>
                    <label for="contraseña" required></label>
                    <input class="cr" id="contraseña" type="password" placeholder="Contraseña..." name="contraseña">
                    <br>
                    <button style="color: white; text-decoration:none" type="submit" class="btn btn-outline-primary in">Inicio sesión</button>
                    <br>
                    <br>
                </form>

                </p>
                <button type="button" class="btn btn-outline-primary rg"><a href="./registro.php" class="card-link" style="color: white; text-decoration:none;">Registrate</a></button>
